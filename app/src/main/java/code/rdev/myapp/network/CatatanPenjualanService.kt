package code.rdev.myapp.network

import code.rdev.myapp.activity.data_barang.data.ResultDataBarang
import code.rdev.myapp.activity.login.data.ResultLogin
import code.rdev.myapp.activity.penjualan.data.ResultKeranjang
import code.rdev.myapp.activity.penjualan.data.ResultSearchBarang
import code.rdev.myapp.activity.report.detail.data.ResultItemKeranjang
import code.rdev.myapp.response.ResultSimple
